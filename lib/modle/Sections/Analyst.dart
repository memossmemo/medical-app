...
class Analyst extends StatefulWidget {
  ...
  @override
  State<Analyst> createState() => _pharmaState();
}

class _pharmaState extends State<Analyst> {
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  @override
  Future<Map<String, dynamic>> fetchAnalyst(String city, String region) async {
    String url =
        'https://pharma-manager-copy-2.onrender.com/api/getAnalystsinCity';
    url += '/$city';
    url += '/$region';
    try {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("مركز التحاليل"),leading: Column(
        children: [
          ...
          children: [
            ...
            Expanded(
              child: FutureBuilder<Map<String, dynamic>>(
                future: fetchAnalyst("${shared?.getString("city")}",
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return ListView.builder(
                      itemCount: snapshot.data!["findAnalyst"].length,
                      itemBuilder: (context, index) {
                        phID.add(snapshot.data!["findAnalyst"][index]["_id"]);
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      SizedBox(height: 20),
                                      Text(
                                        '${snapshot.data!["findAnalyst"][index]["fullName"]}',
                                        style: TextStyle(
                                          fontSize: 24,
                                      ...
                                      SizedBox(height: 10),
                                      Text(
                                        '${snapshot.data!["findAnalyst"][index]["city"].toString().replaceAll("محافظة", "")} /${snapshot.data!["findAnalyst"][index]["region"].toString().replaceAll("مدينة", "")} /${snapshot.data!["findAnalyst"][index]["address"]} ',
                                      ...
                                      SizedBox(height: 10),
                                      Text(
                                        '  مواعيد العمل : من ${snapshot.data!["findAnalyst"][index]["StartJob"]}\n                       الى ${snapshot.data!["findAnalyst"][index]["EndJob"]}  ',
                                        style: TextStyle(
                                            fontSize: 16,
                                            color: Colors.black54),
                                      ),
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            ElevatedButton(
                                              onPressed: () async {
                                                var phoneNumber =
                                                    '${snapshot.data!["findAnalyst"][index]["phone"]}';
                                                final Uri uri = Uri(
                                                    scheme: 'tel',
                                                    path: phoneNumber);
