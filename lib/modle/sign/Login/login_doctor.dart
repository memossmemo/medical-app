...
class Login_doctor extends StatefulWidget {
  ...
  @override
  State<Login_doctor> createState() => _LoginState();
}

class _LoginState extends State<Login_doctor> {
  ...
  Future<void> signinPharmatic() async {
    // The URL of your API
    final url = Uri.parse('https://pharma-manager-copy-2.onrender.com/api/Doctor/signinPharmatic');
